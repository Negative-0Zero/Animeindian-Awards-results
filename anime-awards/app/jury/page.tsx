...
export default function JuryPage() {
  ...
  const [userVotes, setUserVotes] = useState<Record<string, string>>({}) // category -> nominee_id
        ...
        {categories.length === 0 ? (
          ...
          <div className="space-y-8">
            {categories.map(cat => {
              ...
              const votedNomineeId = userVotes[cat.name]

              return (
                <div key={cat.id} className="bg-slate-900/50 border border-white/10 rounded-2xl p-6">
